...
function Card1({img,title,desc,link}) {
  return (
    <div className='text-black bg-white rounded-[8px] lg:max-w-[424px] w-full pt-[32px] pb-[24px] px-[28px] flex'>
        ...
        <Link 
        href="#"
        className='text-blue text-[1.1875rem] font-Founders font-[500] whitespace-nowrap flex items-center'
        >
