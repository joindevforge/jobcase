  ...
  <SplideTrack>
     {
        ...
        <div  className='min-w-[380px] py-[40px] px-[32px] flex flex-col justify-between mr-[1rem]'>
            <div className='max-w-[280px] overflow-hidden mb-[2rem] '>
                <Image
                ...
                alt='hero'
                />
                <p className='text-[1.25rem] font-Inter pt-4 '>
                {item.desc}
                </p>
            </div>
            <div className='flex items-center'>
                ...
                />
                <div>
                    <p className=' font-Inter font-[500] text-[19px] text-blue'>{item.title}</p>
<p className=' font-Inter font-[400] text-[14px] text-zinc-700'>{item.role}</p>
                </div>
            </div>
        </div>
      </SplideSlide>
