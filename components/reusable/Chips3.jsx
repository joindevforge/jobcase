...
function Chips3({title,followers}) {
  return (
    <div className=' min-w-[193px] min-h-[76px]  mb-[1rem]  relative bg-white border border-zinc-300 hover:border-zinc-700 hover:bg-zinc-100 rounded-[8px] p-[1rem] text-[1rem]  '>
